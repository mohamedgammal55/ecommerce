...
class Product extends Model
{
    ...
    public function getColorsPriceAttribute($value)
    {
        if($value == null)
        {
            return '';
    ...
    protected $appends = ['details_clear','policy_clear','product_rate'];

    public function getDetailsClearAttribute()
    {
        return strip_tags(str_replace("&nbsp;", " ", $this->details));
    }

    public function getPolicyClearAttribute()
    {
        return strip_tags(str_replace("&nbsp;", " ", $this->policy));
    }

   public function getProductRateAttribute(){
       $stars = Rating::where('product_id',$this->id)->avg('rating');
