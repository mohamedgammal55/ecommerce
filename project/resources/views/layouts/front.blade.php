...
<!-- favicon -->
    ...
    <!-- stylesheet -->
        <link rel="stylesheet" href="{{asset('assets/front/css/rtl/all.css')}}?v={{time()}}">
    ...
    <!-- stylesheet -->
        <link rel="stylesheet" href="{{asset('assets/front/css/all.css')}}?v={{time()}}">
...
<!-- Bootstrap -->
    <link rel="stylesheet" id="BootstrapLink" href="{{url('')}}/newSite/css/bootstrap.css?v={{time()}}">
    <!-- Material Design Bootstrap -->
    <link rel="stylesheet" id="MDBlink" href="{{url('')}}/newSite/css/mdb.min.css?v={{time()}}">
    <!-- mean menu -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/meanmenu.css?v={{time()}}">
    <!-- select2  -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/select2.css?v={{time()}}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/all.css?v={{time()}}">
    <!-- swiper -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/swiper.css?v={{time()}}">
    <!-- odometer -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/odometer.min.css?v={{time()}}">
    <!-- animate -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/animate.min.css?v={{time()}}">
    <!-- side menu -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/ma5-menu.min.css?v={{time()}}">
    <!-- img gallery -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/jquery.fancybox.min.css?v={{time()}}">
    <!-- Custom style  -->
    ...
    <!-- Bootstrap -->
        ...
        <link rel="stylesheet" id="StyleLink" href="{{url('')}}/newSite/css/style.css?v={{time()}}">

    @else
    <!-- Bootstrap -->
        <link rel="stylesheet" id="BootstrapLink" href="{{url('')}}/newSite/css/bootstrap.rtl.css?v={{time()}}">
        <!-- Material Design Bootstrap -->
        <link rel="stylesheet" id="MDBlink" href="{{url('')}}/newSite/css/mdb.rtl.min.css?v={{time()}}">

        <link rel="stylesheet" id="StyleLink" href="{{url('')}}/newSite/css/styleAR.css?v={{time()}}">

    @endif
<!-- responsive style  -->
    <link rel="stylesheet" href="{{url('')}}/newSite/css/responsive.css?v={{time()}}">
    @toastr_css
...
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-lg-2 col-sm-6 col-12 p-2 order-lg-last">--}}
...
{{--                                <li class="dropdown-item dropdown"><a href="#!"> اخبار </a>--}}
{{--                                    <ul class="dropdown-menu">--}}
{{--                                        <li class="dropdown-item"><a href="#!"> عامة </a> </li>--}}
{{--                                        <li class="dropdown-item"><a href="#!"> مؤتمرات </a> </li>--}}
{{--                                    </ul>--}}

{{--                                </li>--}}
{{--                                <li class="dropdown-item"><a href="#!"> فديو </a> </li>--}}
{{--                                <li class="dropdown-item"><a href="#!"> صور </a> </li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
...
@yield('scripts')
<script src="{{url('')}}/newSite/js/jquery-3.5.1.min.js"></script>
<script src="{{url('')}}/newSite/js/popper.min.js"></script>
<script src="{{url('')}}/newSite/js/jquery.appear.min.js"></script>
<script src="{{url('')}}/newSite/js/bootstrap.min.js"></script>
{{--<script src="newSite/js/mdb.min.js"></script>--}}
<script src="{{url('')}}/newSite/js/swiper.js"></script>
<script src="{{url('')}}/newSite/js/wow.min.js"></script>
<script src="{{url('')}}/newSite/js/jquery.fancybox.min.js"></script>
<script src="{{url('')}}/newSite/js/fontawesome-pro.js"></script>
<script src="{{url('')}}/newSite/js/odometer.min.js"></script>
<script src="{{url('')}}/newSite/js/select2.js"></script>
<script src="{{url('')}}/newSite/js/ma5-menu.min.js"></script>
<script src="{{url('')}}/newSite/js/Custom.js"></script>
<script>
    // side Menu
    @if($langg->rtl != "1")
    ma5menu({
